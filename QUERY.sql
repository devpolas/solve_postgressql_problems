...
CREATE TABLE
  Users (
    ...
    role TEXT NOT NULL CHECK (role IN ('Ticket Manager', 'Football Fan')),
...
CREATE TABLE
  Matches (
    ...
    fixture VARCHAR(255),
    tournament_category VARCHAR(150),
...
SELECT * FROM Matches WHERE match_status = 'Available';
...
SELECT user_id, full_name, booking_id FROM Bookings RIGHT JOIN Users USING(user_id);
